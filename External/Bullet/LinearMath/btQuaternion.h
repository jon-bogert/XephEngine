...
#include "../../../Framework/Math/include/Quaternion.h"
...
#endif
	operator xe::Math::Quaternion() const { return { m_floats[0], m_floats[1], m_floats[2], m_floats[3]}; };
	btQuaternion& operator=(const xe::Math::Quaternion& rhs) { m_floats[0] = rhs.x; m_floats[1] = rhs.y; m_floats[2] = rhs.z; m_floats[3] = rhs.w; return *this; }
	btQuaternion(const xe::Math::Quaternion& other) { m_floats[0] = other.x, m_floats[1] = other.y; m_floats[2] = other.z; m_floats[3] = other.w; }
